        ...
        <section className="my-5">
            ...
            <div className="my-2">
                <p>
                    ...
                    Development
                    Boot Camp with a completion date of May 2021. Prior to web development, I worked in the custom
                    ...
                    MWP
                    Designs, a freelance business where I create graphic art and digital sculptures for the silver
                    collectors'
                    community and custom law enforcement badges.
            </p>
            </div>
        </section>
        )
